            ...
            <div class="kt-grid__item kt-grid__item--fluid  kt-grid__item--order-tablet-and-mobile-1  kt-login__wrapper" style="background-image: url('{{asset('public/assets/metronic/media/bg/bg-3.jpg')}}');">
                ...
                <div class="kt-login__body">
                    ...
                    <div class="kt-login__form">
                        ...
                        <!--begin::Form-->
                        <form class="kt-form" action="{{url('/signup')}}" method='post' novalidate="novalidate">
...
@section('page-js')
<script src="{{asset('public/assets/custom/js/register.js')}}" type="text/javascript"></script>
@endsection
