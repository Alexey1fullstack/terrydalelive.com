                        ...
                        <div class="kt-widget__head">
                            <div class="kt-widget__media">
                                @if (isset($user->photo) && !is_null($user->photo))
                                    <img  alt="Pic" src="{{asset('public/assets/metronic/media/users/'.$user->photo)}}" />
                                @else
                                    <img  alt="Pic" src="{{asset('public/assets/metronic/media/users/default.jpg')}}" />
                                @endif
                            </div>
                        ...
                        <div class="kt-widget__body">
                            <div class="kt-widget__content">
                                ...
                                <div class="kt-widget__info">
                                    ...
                                    <a  class="kt-widget__data">{{$user->phone_num}}</a>
                                </div>
                                <div class="kt-widget__info">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="kt-portlet">
                        ...
                        <form class="kt-form kt-form--label-right" id="profile_update_form" action="{{url('/account')}}" method="post">
                            @csrf
                                ...
                                <div class="kt-section kt-section--first">
                                    <div class="kt-section__body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <div class="input-group">
                                                    <input type="text" name="phone_num" class="form-control" value="{{$user->phone_num}}" placeholder="Phone number" aria-describedby="basic-addon1">
                                                </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <div class="input-group">
                                                    <textarea class="form-control" name="location" id="location" rows="3" style="overflow: hidden; overflow-wrap: break-word; resize: none; height: 160px;">{{$user->location}}</textarea>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="kt-portlet">
                        ...
                        <form class="kt-form kt-form--label-right" id="password_update_form" action="{{url('/password/update')}}" method="post">
                            @csrf
                            <div class="kt-portlet__body">
                                <div class="kt-section kt-section--first">
                                    <div class="kt-section__body">
