                    ...
                    <tbody>
                        <?php if(!empty($cards)): ?>
                            <?php $__currentLoopData = $cards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                               
                                <tr>
                                <td><?php echo e($row->id+1000); ?></td>
                                <td class="icon-td"><img class="mr-5" data-card-img="<?php echo e($row->card_img); ?>" src="<?php echo e(asset('public/assets/imgs/'.$row->get_assettype->name).'.jpg'); ?>" width="30px;"></td>
                                    <td ><?php echo e(date('m/d/Y H:i:s',strtotime($row->updated_at))); ?></td>
                                    <td data-category ="<?php echo e($row->category); ?>">
                                    ...
                                    <td data-type ="<?php echo e($row->type); ?>"><?php echo e($row->get_assettype->icon_name); ?></td>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item change-status" data-status='0' data-cardid="<?php echo e($row->id); ?>" >Open</a>
                                                <a class="dropdown-item change-status" data-status='1' data-cardid="<?php echo e($row->id); ?>"  >Close</a>
                                                <a class="dropdown-item change-status" data-status='2' data-cardid="<?php echo e($row->id); ?>"  >No Deal</a>
                                            </div>
                                        </div>
                                    ...
                                    <td class="text-left">
                                        <a data-card-id = <?php echo e($row->id); ?> class="card_edit  btn btn-sm btn-clean btn-icon btn-icon-md " title="Edit">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        <a onclick="deleted_record(<?php echo e($row->id); ?>)" id="<?php echo e('sel'.$row->id); ?>" class="card_delete btn btn-sm btn-clean btn-icon btn-icon-md " title="Delete">
                                    ...
                                    <div class='form-group'>
                                        ...
                                        <div class='input-group'>
                                            <select class='form-control' id='new_type' name = "type" Placeholder = "Enter assets type" required>
                                                <option ></option>
                                                <?php $__currentLoopData = $assettype; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value='<?php echo e($type->id); ?>'><?php echo e($type->icon_name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                                    
                                            </select>
                                        </div>
                                    </div>                                
    ...
    <script>
            ...
            var update_card = function()
        {
            $('#update_card_btn').click(function(){
                ...
                form.ajaxSubmit({
                url: "<?php echo e(url('/card/update')); ?>",
        ...
        var new_card = function()
            {
                $('#new_card_btn').click(function(){
                    ...
                    _this.addClass('kt-spinner kt-spinner--right kt-spinner--sm kt-spinner--light').attr('disabled', true);
                    form.ajaxSubmit({
                    url: "<?php echo e(url('/card/updateonlist')); ?>",
                    success: function(response, status, xhr, $form) {
                        // similate 2s delay
                        if(response.success){
            ...
            var change_status = function(){
                $(document).on('click','.change-status',function(){
                    ...
                    jQuery.ajax({
                        url: "<?php echo e(url('/card/status/')); ?>",
                        method: 'post',
                        data: {
                            cardid: cardid,
                            status: status,
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/remiu49263hb/public_html/resources/views/cards/clist.blade.php ENDPATH**/ ?>