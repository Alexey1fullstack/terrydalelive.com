                        ...
                        <?php if(!empty($users)): ?>
                            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($row->phone_num); ?></td>
                                    <td><?php echo e($row->location); ?></td>
                                    <td>
                                        <?php if($row->member == 1): ?>
                                            <span data-uid="<?php echo e($row->id); ?>" class="member  kt-badge  kt-badge--primary kt-badge--inline kt-badge--pill ">Admin</span>
                                        <?php else: ?>
                                            <span data-uid="<?php echo e($row->id); ?>"  class="member kt-badge  kt-badge--success kt-badge--inline kt-badge--pill ">User</span>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <?php if($row->permission == 1): ?>
                                            <span  data-uid="<?php echo e($row->id); ?>" class="permission kt-badge  kt-badge--success kt-badge--inline kt-badge--pill ">Active</span>
                                        <?php else: ?>
                                            <span  data-uid="<?php echo e($row->id); ?>" class="permission kt-badge  kt-badge--danger kt-badge--inline kt-badge--pill ">Unactive</span>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <?php echo e(date('m/d/Y h:m:s',strtotime($row->created_at))); ?>

                                    </td>
                                    <td class="text-left">

                                        <a onclick="deleted_record(<?php echo e($row->id); ?>)" id="<?php echo e('sel'.$row->id); ?>" class="btn btn-sm btn-clean btn-icon btn-icon-md delete_record" title="Delete">
        ...
        var create_project = function(){
            ...
            var change_member = function(){
                $(".member").click(function(){
                    ...
                    jQuery.ajax({
                        url: "<?php echo e(url('/user/member/')); ?>",
                        method: 'post',
                        data: {
                            uid: uid,
            ...
            var change_permission = function(){
                $(".permission").click(function(){
                    ...
                    jQuery.ajax({
                        url: "<?php echo e(url('/user/permission/')); ?>",
                        method: 'post',
                        data: {
                            uid: uid,
            ...
            var create_new_user = function()
            {
                $('#new_user_btn').click(function(){
                    ...
                    form.ajaxSubmit({
                        url: "<?php echo e(url('/user/new_user')); ?>",
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/remiu49263hb/public_html/resources/views/user/userlist.blade.php ENDPATH**/ ?>