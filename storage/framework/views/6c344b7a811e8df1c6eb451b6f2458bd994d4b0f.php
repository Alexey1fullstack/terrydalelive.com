...
<html lang="en">
	...
	<head>
		...
		<!--end::Base Path -->
		<meta charset="utf-8" />
		<title> <?php echo e($setting->site_name); ?> | permission</title>
        ...
        <link href="<?php echo e(asset('public/assets/metronic/css/demo1/pages/general/error/error-3.css')); ?>" rel="stylesheet" type="text/css" />
	...
	<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--fixed kt-subheader--enabled kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
		...
		<div class="kt-grid kt-grid--ver kt-grid--root">
			<div class="kt-grid__item kt-grid__item--fluid kt-grid  kt-error-v3" style="background-image: url(<?php echo e(asset('public/assets/metronic/media/error/bg3.jpg')); ?>)">
				<div class="kt-error_container">
                    ...
                    <p class="kt-error_title kt-font-black">
                        Support Email: <?php echo e($setting->site_email); ?>
...
<?php /**PATH /home/remiu49263hb/public_html/resources/views/errors/nopermission.blade.php ENDPATH**/ ?>