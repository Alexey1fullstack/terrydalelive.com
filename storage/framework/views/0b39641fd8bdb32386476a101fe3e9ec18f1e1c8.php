            ...
            <div class="hero">
                <header>
                    <div class="container">
                        <div class="logo col-xs-4">
                            <a href="<?php echo e(url('/')); ?>"><img src="<?php echo e(asset('public/assets/imgs/logo-dark.svg')); ?>" alt="" class="m-logo"></a>
                        </div>
                        <div class="f-right col-xs-8">
                        </div>
                        <nav class="menu" id="myTopnav">
                            ...
                            <a class="menu-items" href="<?php echo e(url("about")); ?>"> About Us </a>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-8  float-right show-on-scroll text-left">
...
We are in the process of creating a private deal room for preferred investors that will have even more access to select opportunities with continuous updates. Stay tuned!
                                                            ...
                                                            <div class="card-box"  id="item<?php echo e($row->id); ?>" data-card-state = "<?php echo e($row->value1); ?>" card-type="<?php echo e($row->get_assettype->icon_name); ?>">
                                                                ...
                                                                <div class="card-list">
                                                                    ...
                                                                    <div class="col-xs-8  text-center">
                                                                        <span class="card-name  card-value1"><?php echo e($row->value1); ?></span>
                                                                    </div>
                                                                </div>
                                                                <div class="card-list">
                                                                    <div class="col-xs-6">
                ...
                <div class="footer col-md-12">
                    <div class="container">
                        ...
                        <div class="col-md-3 about">
                            ...
                            <p class="f-content">Headquartered in Dallas, Texas, Terrydale Capital is a leader in commercial real estate financing. We have close relationships with the nation’s top banks, lenders & family offices allowing us to provide the most competitive financing solutions in the market
                            </p>
                        ...
                        <div class="col-md-3 services">
                            ...
                            <a href='https://www.terrydalecapital.com/loan-programs'>Loan Programs </a><br>
                            <a href='https://www.terrydalecapital.com/capital-finance/'>Capital Finance</a><br>
                            <a href='https://www.terrydalecapital.com/advisory-consultation/'>Advisory & Consultation</a><br>
                            <a href='https://www.terrydalecapital.com/property-types/'>Property Types</a><br>
                        </div>
                        <div class="col-md-3 links">
                            <p class="f-title">Links</p>
                            <a href='https://www.terrydalecapital.com/'>Main Website</a><br>
                            <a href='https://www.terrydalecapital.com/loans/'>Loans</a><br>
                            <a href='https://www.terrydalecapital.com/resources/'>Resources</a><br>
                            <a href='https://www.terrydalecapital.com/about/'>About Us</a><br>
                        </div>
                        <div class="col-md-3 contact-info">
                            ...
                            <div class="wrap">
                                ...
                                <div>
                                    <a> 5740 Prospect Ave STE 3001 Dallas, TX 75206</a>
                                </div>
                                <br><br>
                            </div>
                            <div class="wrap">
                    ...
                    <div class="bottom-bar container">
                        ...
                        <div class="col-md-4 t-center">
                            <a href="#"><img src="<?php echo e(asset('public/assets/imgs/logo-dark.svg')); ?>" alt="" class="b-logo"></a>
                        </div>
                        <div class="col-md-4">
                        	<p>
                        		<span class="f-right">@2020  Copyright.All rights reserved</span>
                        	</p>
    ...
    <script>
        setInterval(()=>{
            ...
            // let active_count = $('#check_active_count').val();
            // let inactive_count = $('#check_inactive_count').val();
            ...
            reference= reference.toString();
                $('#slide1 .owl-carousel').owlCarousel().trigger('add.owl.carousel', [jQuery("<div class='col-md-12'><div class='card opened-card'  ><div class='box-header'><img class='card-icon' src='<?php echo e(asset('/public/assets/imgs/')); ?>/"+element.card_img+"' alt='ddd' width='50px'><span class='card-name card-type' >"+element.card_type+"</span></div><div class='card-box'  data-card-state='"+element.value1+"' card-type='"+element.card_type+"'><div class='card-list'><div class='col-xs-4'><span class='pre-key'>Location:</span></div><div class='col-xs-4  text-center'><span class='card-name card-value1'>"+element.value1+"</span></div></div><div class='card-list'><div class='col-xs-6'><span class='pre-key'>Asking Price:</span></div><div class='col-xs-6'><span class='card-name card-value2'>"+element.value2+"%</span></div></div><div class='card-list'><div class='col-xs-6'><span class='pre-key'>EST. LTV:</span></div><div class='col-xs-6'><span class='card-name card-value3'>"+element.value3+"%</span></div></div><div class='card-list'><div class='col-xs-8'><span class='pre-key'>Cash on Cash Return:</span></div><div class='col-xs-4'><span class='card-name   card-value4'>"+element.value4+"%</span></div></div> <div class='card-list'><div class='col-xs-6'><span class='pre-key'>CAP Rate:</span></div><div class='col-xs-6'><span class='card-name   card-value5'>"+element.value5+"%</span></div></div></div><div class='t-center'><button   class='btn initial-btn modal_submit'>Contact Us</button></div><div class='reference-number'><div class='col-xs-12 text-center'><span class=''>"+get_category(element.category)+" #"+reference+"</span></div></div></div></div>"),0]).trigger('refresh.owl.carousel');
            };
            ...
            reference= reference.toString();
                ...
                $('.closed-slide .owl-carousel').owlCarousel().trigger('add.owl.carousel', [jQuery("<div class='col-md-12'><div class='card opened-card'  ><div class='box-header'><img class='card-icon' src='<?php echo e(asset('/public/assets/imgs/')); ?>/"+element.card_img+"' alt='ddd' width='50px'><span class='card-name card-type' >"+element.card_type+"</span></div><div class='card-box'  data-card-state='"+element.value1+"' card-type='"+element.card_type+"'><div class='card-list'><div class='col-xs-4'><span class='pre-key'>Location:</span></div><div class='col-xs-8  text-center'><span class='card-name card-value1'>"+element.value1+"</span></div></div><div class='card-list'><div class='col-xs-6'><span class='pre-key'>Asking Price:</span></div><div class='col-xs-6'><span class='card-name card-value2'>"+element.value2+"%</span></div></div><div class='card-list'><div class='col-xs-6'><span class='pre-key'>EST. LTV:</span></div><div class='col-xs-6'><span class='card-name card-value3'>"+element.value3+"%</span></div></div><div class='card-list'><div class='col-xs-8'><span class='pre-key'>Cash on Cash Return:</span></div><div class='col-xs-4'><span class='card-name   card-value4'>"+element.value4+"%</span></div></div> <div class='card-list'><div class='col-xs-6'><span class='pre-key'>CAP Rate:</span></div><div class='col-xs-6'><span class='card-name   card-value5'>"+element.value5+"%</span></div></div></div><div class='t-center'><button   class='btn initial-btn modal_submit'>Contact Us</button></div><div class='reference-number'><div class='col-xs-12 text-center'><span class=''>"+get_category(element.category)+" #"+reference+"</span></div></div></div></div>"),0]).trigger('refresh.owl.carousel');
...
<?php /**PATH E:\xampp\htdocs\0527_terrydalelive\resources\views/home.blade.php ENDPATH**/ ?>